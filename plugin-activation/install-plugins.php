...
function stanleywp_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'mvpwp CPT plugins', // The plugin name.
			'slug'               => 'mvpwp-CPT-plugins', // The plugin slug (typically the folder name).
		...
		array(
			'name'      => 'CMB2', // popular meta box
			'slug'      => 'cmb2',
			'required'  => true,
		),

		array(
			'name'      => 'Kirki', // toolkits cust. plugins
			'slug'      => 'kirki',
			'required'  => true,
		),
